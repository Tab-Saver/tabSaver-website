        ...
        <div className="max-w-6xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-gray-600 mb-8 max-w-3xl mx-auto">
              Save all your open tabs in one click. Organize
              your browsing sessions and restore them anytime,
              anywhere.
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Button
                size="lg"
                className="bg-gradient-to-r from-yellow-400 to-yellow-500 text-gray-900 hover:from-yellow-500 hover:to-yellow-600 text-lg px-8 py-6"
              >
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-center text-gray-600 mb-16 max-w-2xl mx-auto">
              The fastest and easiest way to manage your browser
              tabs
            </p>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              >
                ...
                <p className="text-gray-600">
                  Save all your open tabs instantly with a
                  single click. No complicated setup or
              ...
              >
                ...
                <p className="text-gray-600">
                  Group your tabs into named sessions. Perfect
                  for different projects, research topics, or
                  workflows.
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="text-gray-600">
                  Restore your saved sessions instantly. Pick up
                  right where you left off, even after closing
                  your browser.
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="text-gray-600">
                  ...
                  collect, store, or share any of your browsing
                  information.
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="text-gray-600">
                  Optimized for speed and performance. Doesn't
                  slow down your browser or consume excessive
                  resources.
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="text-gray-600">
                  No premium features, no subscriptions, no
                  paywalls. Everything you need is completely
                  free forever.
                </p>
              </motion.div>
            </div>
          ...
          >
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              >
                ...
                <p className="text-gray-600">
                  Add Tab Saver to Chrome from the Web Store. It
                  installs in seconds and appears in your
                  toolbar.
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="text-gray-600">
                  Click the extension icon and save all your
                  current tabs. Give your session a name for
                  easy reference.
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="text-gray-600">
                  Open the extension to view all saved sessions.
                  Click any session to restore all those tabs
                  instantly.
                </p>
              </motion.div>
            </div>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          >
            ...
            <p className="text-center text-gray-600 mb-12">
              Found a bug? Have a feature request? We'd love to
              hear from you!
            </p>
      ...
      <footer className="py-12 px-6 bg-gray-900 text-white">
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-3 gap-8 mb-8">
            <div>
              ...
              <p className="text-gray-400 text-sm">
                The simplest way to save and restore your
                browser tabs.
              </p>
            </div>
          ...
          <div className="pt-8 border-t border-gray-800 text-center text-sm text-gray-400">
            <p>
              © 2025 Tab Saver. Built with ❤️ by Omar Hamdan.
              All rights reserved.
            </p>
          </div>
        </div>
